...
/**
 * NeoForge-specific implementation of the platform helper.
 * Handles NeoForge-specific API for events and player interaction.
 * NeoForge shares many APIs with Forge, but has some differences.
 */
public class NeoForgePlatformHelper implements IPlatformHelper {
    ...
    public void registerEventHandlers() {
        // NeoForge events are registered via the mod event bus in the main class
    }
